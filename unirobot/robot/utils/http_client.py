...
class HTTPPolicyClient:
    ...
    def __init__(self, base_url: str = "https://u691691-9c18-54f8ef79.bjb1.seetacloud.com:8443"):
...
if __name__ == "__main__":
    ...
    data_list = []
    client = HTTPPolicyClient(base_url="https://u2691691-9c18-54f8ef79.bjb1.seetacloud.com:8443")
    ...
    with h5py.File("episode_1.hdf5", "r") as root:
        for frame_cnt in range(root["/action"].shape[0]):
            ...
            data['qpos']=qpos
            data['hand']=root[f"/observations/images/hand"][frame_cnt]
            data['top']=root[f"/observations/images/top"][frame_cnt]
